...
\begin{align}
    \sigma_t^2 = \delta + a(\varepsilon_{t-1}) \sigma_{t-1}^2, \quad \text{where }a(\varepsilon_t)=\alpha\varepsilon_t^2+\beta
\end{align}
...
\begin{gather}
    \sigma_i^2(t) = \delta(t) + a(\varepsilon_{i-1}(t)) \sigma_{i-1}^2(t), \quad \text{where }a(\varepsilon_i(t))(t,s)=\alpha\varepsilon_t^2(t)+\beta
\end{gather}
The necessary condition for a stationary solution is then:
