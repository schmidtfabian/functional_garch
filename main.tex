...
\end{gather}
In the following, conditions for the existence of a stationary solution to the Functional GARCH(1,1) model are discussed. \citet{Aue2017} derive the conditions both for the space $L^2[0,1]$ as well as the space of continuous functions $C[0,1]$. I will first focus on solutions in $L^2[0,1]$.\\
To emphasize the condition necessary for the existence of a stationary solution, \citeauthor{Aue2017} rewrite
